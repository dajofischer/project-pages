...
## Rule
<script src="https://demo.bokeh.org/slider/autoload.js?bokeh-autoload-element=1001&bokeh-app-path=/slider&bokeh-absolute-url=https://demo.bokeh.org/slider" id="1001"></script>
---
